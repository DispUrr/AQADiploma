...
Приложение предлагает купить тур в Марракэш двумя способами:
...
| 11|Оплата через опицю **Купить** с незаполненной картой|В поле **Номер карты** не ввводить данные;<br>Остальные данные заполнены корректно|Под полем **Карта** появилось сообщение **Поле обязательно для заполнения**;<br>В БД запись отсуствует|
...
- Подготовка отчёта по итогам автоматизации.